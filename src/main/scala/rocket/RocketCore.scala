...
object ImmGen {
  def apply(sel: UInt, inst: UInt) = {
    val sign = Mux(sel === IMM_Z || sel === IMM_5, SInt(0), inst(31).asSInt)
    ...
    val b10_5 = Mux(sel === IMM_U || sel === IMM_Z, Bits(0), 
                Mux(sel === IMM_5, SInt(0), inst(30,25)))
    val b4_1 = Mux(sel === IMM_U, Bits(0),
               Mux(sel === IMM_S || sel === IMM_SB, inst(11,8),
               Mux(sel === IMM_Z, inst(19,16),
               Mux(sel === IMM_5, SInt(2, 4), inst(24,21)))))
    val b0 = Mux(sel === IMM_S, inst(7),
             Mux(sel === IMM_I, inst(20),
             Mux(sel === IMM_Z, inst(15),
             Mux(sel === IMM_5, SInt(1), Bits(0)))))
